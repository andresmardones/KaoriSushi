		...
		<div class="col-xs-12 text-center verificar">
			...
			<?php
				...
				if ($usuarioVerificado) {
					...
					echo '<h3>Gracias</h3>
						  <h2><small>Se ha verificado su correo electrónico, ¡ya puede ingresar al sistema!</small></h2>
					...
					echo '<h3>Error</h3>
						  <h2><small>No se ha podido verificar su correo electrónico, vuelva a registrarse</small></h2>
