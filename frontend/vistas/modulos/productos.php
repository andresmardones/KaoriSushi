...
<div class="container-fluid productos">
	...
	<div class="container">
		...
		<div class="row">
			...
			if ($rutas[0] == "ultimos-agregados") {
				
				$item2 = null;
				$valor2 = null;
				$ordenar = "id";

			}elseif ($rutas[0] == "rolls-mas-vendidos") {
				
				$item2 = null;
				$valor2 = null;
				$ordenar = "ventas";

			}elseif ($rutas[0] == "rolls-mas-vistos") {
				...
				<?php
					...
					if (count($listaProductos) != 0) {
						...
						if ($pagProductos > 4) {
							...
							/*=====================================================
							=           BOTONES DE LA MITAD HACIA ABAJO           =
							=====================================================*/
							...
							/*=====================================================
							=          BOTONES DE LA MITAD HACIA ARRIBA           =
							=====================================================*/
